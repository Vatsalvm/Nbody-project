...
double precision :: r(1:3,1:3), v(1:3,1:3), a(1:3,1:3), a0(1:3,1:3), m(1:3), dt, tcurr, tout, G, dr(1:3)
...
double precision :: rad2, AU, yr, com(1:3), cov(1:3), mtot, KE, PE, Ei, Ecurr, delE, rad, tcount, techeck
...
r(2:3,1:3) = 0. !forcing the objects to remain in the XY plane
!Orbital velocities of SUN-JUPITER-EARTH in the solar system (in m/s)
v(2,1:3) = (/0., 13.7*1000 ,30.*1000/)
v(1,1:3) = 0. 
v(3,1:3) = 0. !allowing the object to move in circular paths on the XY plane.
...
tcurr = 0.
!Time for the simulations, tout = 10.0 yrs
...
!-------------------------------------------------------
!Finding initial acceleration,a0 of the SUN-JUPITER-EARTH
dr(1:3) = 0.
do i=1,n
	a0(1:3,i) = 0.
	do j=1,n
...
OPEN(4,file='FRACnew1000.txt',status='new')
