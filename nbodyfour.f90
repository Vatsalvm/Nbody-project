...
!open(5,file='encheck_1Millyrs_adaptive_dt1_new.txt',status='new')
...
!        write(5,*) tcurr/yr,delE
    ...
    !x-----Measuring the distance from the sun-----x
        ...
        write(6,*) '$$$$$$$$$$$$$$$$$$$$'
        write(6,*) 'dsun_earth =',dsun(3)/AU, dt
...
!        write(6,*) '        '
        ...
        do i=1,n
            !r_newpast(1:3,i,-1) = (1./128.)*(-5.*r(1:3,i,-4) + 28.*r(1:3,i,-3) - 70.*r(1:3,i,-2) + 140.*r(1:3,i,-1) + 35.*r(1:3,i,0))
            ...
            !r_newpast(1:3,i,-3) = (1./128.)*(3.*r(1:3,i,-4) - 20.*r(1:3,i,-3) + 90.*r(1:3,i,-2) + 60.*r(1:3,i,-1) - 5.*r(1:3,i,0))
...
!        write(6,*) 'v(2,3,-8:0) = ',v(2,3,-8:0)/1000.
...
!    write(6,*) '#-----Before downshifting-----#:',dt
!    write(6,*) 'v(2,3,-8:0) = ',v(2,3,-8:0)/1000.
    do p=-8,-1
        do i=1,n
    ...
    do i=1,n
        r(1:3,i,0) = r_c(1:3,i,1)   !the past steps are downshifted so that the corrected value at t=+1 can occupy t=0 step
        v(1:3,i,0) = v_c(1:3,i,1)
        a(1:3,i,0) = a_c(1:3,i,1)
    end do

!    write(6,*) '#-----after downshifting------#:'
!    write(6,*) 'v_c(2,3,1) = ',v_c(2,3,1)/1000.
!    write(6,*) 'v(2,3,-8:0) = ',v(2,3,-8:0)/1000.
!    write(6,*) '            '
!    write(6,*) '            '
!    write(6,*) '            '
