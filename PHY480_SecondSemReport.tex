...
\begin{figure} [h]
\includegraphics[width=8cm,height=8cm]{innerplanets_dt500.jpg}
\centering
...
Now, the initial timestep is set at 1.0 s and the fractional energy of the system is checked for the planets. 
