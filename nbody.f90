...
OPEN(3,file='positions1.txt',status='new')
...
do 
	...
	!WRITE (6,*) '........'
	!WRITE (6,*)	'........'
	!WRITE(6,*) 'The current time=',tcurr/yr, 'yrs'
	tcurr = tcurr + dt
	if(tcurr>tout) exit
	!Storing the current time and also the x and y position values onto a file
	WRITE (3,*) (tcurr*(1/yr)), r(1:2,1:3)
...
!CoM correction for three-body system
